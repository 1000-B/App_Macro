...
# Single input box for both selecting and entering a new food
food = st.selectbox("Enter or Select Food", options=["(New Food)"] + list(food_data.keys()))

# If the user selects "(New Food)", allow manual entry
if food == "(New Food)":
    food = st.text_input("Enter New Food Name")
